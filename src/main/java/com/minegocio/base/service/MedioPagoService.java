 ...
 * 
 * public interface MedioPagoService extends
 * IReadService<MedioPago>,IWriteService<MedioPago>{
 * 
 * List<MedioPago> findByNombre(String nombre); List<MedioPago>
 * findByTipoMedioPago(TipoMedioPago tipo); }
 */
